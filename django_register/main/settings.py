...
from .my_settings import MY_KEY, MY_DATABASES, MY_EMAIL
############# 추가 ##############

SECRET_KEY = MY_KEY['SECRET_KEY']
DATABASES = MY_DATABASES # my sql 적용
...
SERVER_EMAIL        = MY_EMAIL['SERVER_EMAIL']
...
# SECRET_KEY = 'django-insecure-hvxdfrr#%c+#&cilcl2j6d@mul9fgrs5j@i+vj7ha2cnud_uk)'
